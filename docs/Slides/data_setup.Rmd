...
Another option: Use the sample to **build** a model and then **predict** $y$ over all the population units.
...
Estimator can be rather biased when the model is misspecified.
