...
Survey weights, $w_i$'s, .mauve[don't depend] on the $y_i$'s!
...
Estimator is also .mauve[calibrated] to the auxiliary data:
...
* For mis-specified models, don't get much (if any) gains in precision
...
How should I pick .mauve[which] assisting model to use?
